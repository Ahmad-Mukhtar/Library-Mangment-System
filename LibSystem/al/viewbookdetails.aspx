<%@ Page Title="" Language="C#" MasterPageFile="~/al/afterlogin.Master" AutoEventWireup="true" CodeBehind="viewbookdetails.aspx.cs" Inherits="LibSystem.al.viewbookdetails" %>
    ...
    <form runat="server">
        ...
        <p class="bookinfo">Book Description: <%#Eval("BookDescription")%></p>
                        ...
                        <div class="row-custom">
                            ...
                            <asp:Button ID="favbtn"   CssClass="btn btn-primary btn-block" Text="Add to Favouites" onclick="addtofav" runat="server" />
                                <br />  
