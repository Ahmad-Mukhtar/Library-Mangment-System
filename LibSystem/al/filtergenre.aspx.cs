...
{
    public partial class filtergenre : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string gen = Request.Cookies["gencookie"].Value.ToString();

            if (bll.getbookbygenre(gen)!=null)
            {

                noresults.Visible = false;
                datlis1.DataSource = bll.getbookbygenre(gen);
                datlis1.DataBind();
            }
