<%@ Page Title="" Language="C#" MasterPageFile="~/AdminofLib/ad.Master" AutoEventWireup="true" CodeBehind="updatebookadmin1.aspx.cs" Inherits="LibSystem.AdminofLib.updatebookadmin1" %>
                ...
                <div class="col-md-5">
                    <div class="card-custom">
                        <div class="card-body-custom">
                            ...
                            <div class="row">
                                <div class="col-4">
       <asp:Button  ID="button1" CssClass="btn btn-primary btn-block" Text="Update Book" onclick="onupdatebtnclick" OnClientClick="return checkvalidation();" runat="server" />
